...
initial begin
    ...
    $display("--- RAM: program.hex bellege yuklendi ---");
    // Belleğin ilk 4 hücresini kontrol edelim
    $display("RAM[0]=%h, RAM[1]=%h, RAM[2]=%h, RAM[3]=%h", mem[0], mem[1], mem[2], mem[3]);
end
    // ------------------------
